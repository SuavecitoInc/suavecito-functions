  ...
  return {
    ...
    body: JSON.stringify({
      ...
      configuration: {
        ...
        shipCountryCode: metafieldValue?.shipCountryCode,
        minPurchaseAmount: metafieldValue?.minPurchaseAmount,
      },
    }),
  };
};
  ...
  const {
    ...
    fields: {
      ...
      configuration: {
        ...
        shipCountryCode: useField(
          discountConfiguration?.shipCountryCode ?? "US",
        ),
        minPurchaseAmount: useField(
          discountConfiguration?.minPurchaseAmount.toString() ?? "0",
        ),
      },
    },
    onSubmit: async (form) => {
